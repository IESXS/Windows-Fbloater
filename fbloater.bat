...
echo what does this script do uncle IESXS?
echo it removes bloatware.
echo and what the heck is bloatware, uncle IESXS?
echo bloatware is a unwanted software included on a new computer or mobile device by the manufacturer.
echo why remove it? to free up some RAM, and to a little bit more of privacy, like telemetry.
echo I dont take any responsability of the things you do to YOUR computer, use this at you own risk.

echo when you run it, just relax, it may take some time
...
color 0d
type "%~dp0fbloater.txt"

pause

echo oh, alright, lets do it
color 0a
...
echo nothing more to do here, i think.
echo hey! its dangerous on the internet, turn on your VPN
